...
public class ModBiomes {
    ...
    public static Biome venusBiome(Registerable<Biome> context) {
        ...
        return new Biome.Builder()
                ...
                .effects((new BiomeEffects.Builder())
                        ...
                        .music(MusicType.createIngameMusic(RegistryEntry.of(SoundEvents.AMBIENT_UNDERWATER_ENTER))).build())
                .build();
    }
}