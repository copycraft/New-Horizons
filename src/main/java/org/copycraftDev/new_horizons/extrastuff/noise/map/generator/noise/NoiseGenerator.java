package org.copycraftDev.new_horizons.extrastuff.noise.map.generator.noise;
...
public class NoiseGenerator extends AbstractGenerator implements Grid.CellConsumer {
    ...
    public static void generate(final Grid grid, final int radius, final float modifier, final int seed) {
